...
const meunItemVariants = tv({
    base: "flex flex-row w-full h-fit hover:bg-slate-100 disabled:hover:bg-transparent truncate text-sm text-left text-slate-900 disabled:text-slate-400 disabled:cursor-not-allowed p-2 rounded-md",
    variants: {
        checked: {
            true: "bg-slate-100",
        },
