...
const buttonVariants = tv({
    ...
    variants: {
        variant: {
            ...
            secondary: "text-white border-slate-700 bg-slate-700 hover:border-slate-900 hover:bg-slate-900 focus:ring-slate-200 disabled:border-slate-300 disabled:bg-slate-300",
            ...
            ghost: "border-transparent bg-transparent font-medium text-slate-700 shadow-none hover:bg-slate-100 disabled:bg-transparent disabled:text-slate-400",
        },
        radius: {
            full: "rounded-full",
            lg: "rounded-lg",
